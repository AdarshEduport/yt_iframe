...
class YoutubePlayerController implements YoutubePlayerIFrameAPI {
  ...
  YoutubePlayerValue _value = YoutubePlayerValue(isControlsVisible: true);
  ...
  @override
  Future<void> enterFullScreenN() {
    return _run('enterFu');
  }

  @override
  Future<void> exitFullScreenN() {
    return _run('unMute');
  }
